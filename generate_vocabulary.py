...
possible_questions = [
    "What is the psychology term {0} called in Chinese?",
    "What should {0} be called in Chinese psychological literature?",
    "In psychology, what is {0} in Chinese?",
    "How to say {0} in Chinese, as a psychology terminology?"
]
